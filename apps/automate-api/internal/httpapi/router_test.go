...
func TestRouter_Healthz(t *testing.T) {
	r := NewRouter(config.Config{Env: config.EnvDev, FileStore: config.FileStoreLocal}, seedFake())
...
func TestRouter_Readyz(t *testing.T) {
	r := NewRouter(config.Config{Env: config.EnvSIT, FileStore: config.FileStoreLocal}, seedFake())
